class GrupoPreferencia {
  ...
  factory GrupoPreferencia.fromMap(Map<String, dynamic> json) =>
      GrupoPreferencia(
        ...
        preferencias: json["preferencias"] == null
            ? []
            : List<Preferencia>.from(
                json["preferencias"]!.map((x) => Preferencia.fromMap(x))),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "preferencias": preferencias == null
            ? []
            : List<dynamic>.from(preferencias!.map((x) => x.toMap())),
      };
}
